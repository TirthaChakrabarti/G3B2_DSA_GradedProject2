...
public class BSTModificationImplementation implements BSTModificationInterface {
	...
	public void displayNodesInAscendingOrder(Node root) {
		...
		System.out.println("1. Modify existing BST to Right-Skewed Tree by Right Rotation");
		System.out.println(
				"2. Create a new Right-Skewed Tree using existing BST node values while keeping the BST intact");
		System.out.print("\nChoose you option: ");
	...
	// Methods for creating a new Right-Skewed Tree using BST node values
